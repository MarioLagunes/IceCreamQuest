...
public class Nivel2 implements Screen,InputProcessor{
    ...
    private mx.itesm.icecreamquest.Fondo fondo,fondo2,fondo3,fondo4,fondo5,fondoEx,fondoExI,fondoEx1,fondoEx2,fondoPiso1,fondoPiso2,fondoPiso3,fondoCarre1,
    ...
    private mx.itesm.icecreamquest.Personaje.EstadoMovimiento estadoMovimiento;
    private mx.itesm.icecreamquest.Personaje.EstadoSalto estadoSalto;
    private mx.itesm.icecreamquest.Boton btnSaltar,btnPausa,btnReanudar,btnSalir,ganar,perder,btnDer,btnIzq,btnRegreso,btnSiguiente;
    ...
    private mx.itesm.icecreamquest.Musica musicaNivel2;
    ...
    private void crearObjetos() {
        ...
        musicaNivel2 = new mx.itesm.icecreamquest.Musica(musica,true,ajuste);

        fondoNubes = new mx.itesm.icecreamquest.Fondo(textCapaNubes);
        fondoNubes2 = new mx.itesm.icecreamquest.Fondo(textCapaNubes);

        btnSiguiente = new mx.itesm.icecreamquest.Boton(textSiguiente);
        btnRegreso = new mx.itesm.icecreamquest.Boton(textRegreso);
        ...
        btnSaltar = new mx.itesm.icecreamquest.Boton(textBtnSaltar);
        btnPausa = new mx.itesm.icecreamquest.Boton(textBtnPausa);
        btnReanudar = new mx.itesm.icecreamquest.Boton(textBtnReaunudar);
        btnSalir = new mx.itesm.icecreamquest.Boton(textBtnSalir);
        marcador = new Sprite(texturaScore);
        ganar = new mx.itesm.icecreamquest.Boton(texturaGanaste);
        perder = new mx.itesm.icecreamquest.Boton(texturaPerdiste);
        pausa = new Sprite(texturaPausa);
        btnDer = new mx.itesm.icecreamquest.Boton(textBtnDer);
        btnIzq = new mx.itesm.icecreamquest.Boton(textBtnIzq);
        ...
        fondo = new mx.itesm.icecreamquest.Fondo(edificiosIzq);
        fondo2 = new mx.itesm.icecreamquest.Fondo(edificiosIzq);
        fondoEx = new mx.itesm.icecreamquest.Fondo(edificiosIzq);
        fondoEx1 = new mx.itesm.icecreamquest.Fondo(edificiosIzq);
        fondoEx2 = new mx.itesm.icecreamquest.Fondo(edificiosIzq);
        fondoPiso1 = new mx.itesm.icecreamquest.Fondo(fondoPiso);
        fondoPiso2 = new mx.itesm.icecreamquest.Fondo(fondoPiso);
        fondoPiso3 = new mx.itesm.icecreamquest.Fondo(fondoPiso);

        fondo3 = new mx.itesm.icecreamquest.Fondo(edificiosDer);
        fondo4 = new mx.itesm.icecreamquest.Fondo(edificiosDer);
        fondoExI = new mx.itesm.icecreamquest.Fondo(edificiosDer);
        fondo5 = new mx.itesm.icecreamquest.Fondo(fondoNoche);
        ...
        pinguino = new mx.itesm.icecreamquest.Personaje(texuturaPersonaje,textPingDer,textPingIzq);
        ...
        fondoCarre1 = new mx.itesm.icecreamquest.Fondo(textCarreIzq);
        fondoCarre2 = new mx.itesm.icecreamquest.Fondo(textCarreIzq);
        fondoCarre3 = new mx.itesm.icecreamquest.Fondo(textCarreIzq);
        fondoCarre4 = new mx.itesm.icecreamquest.Fondo(textCarreDer);
        fondoCarre5 = new mx.itesm.icecreamquest.Fondo(textCarreDer);
        fondoCarre6 = new mx.itesm.icecreamquest.Fondo(textCarreDer);
    ...
    public void render(float delta) {
        ...
        if((pinguino.getX2() >= 660/*cono.getX()*/ || pinguino.getX2()+pinguino.getSprite2().getWidth() > 710) && (pinguino.getX2() <= 870 /*(cono.getX()+cono.getWidth()) <= (pinguino.getX2()+pinguino.getSprite2().getWidth())*/)
                ...
                && (pinguino.getEstadoSalto() != mx.itesm.icecreamquest.Personaje.EstadoSalto.SUBIENDO || pinguino.getEstadoSalto() != mx.itesm.icecreamquest.Personaje.EstadoSalto.BAJANDO ) ){
            pinguino.puntos += 500;
        ...
        /*if((pinguino.getX2() >= 0 || pinguino.getX2()+pinguino.getSprite2().getWidth() > 0) && (pinguino.getX2() <= 50)
        ...
        if((pinguino.getX2() >= 0/*cono.getX() || pinguino.getX2()+pinguino.getSprite2().getWidth() > 0) && (pinguino.getX2() <= 50)
        ...
        if(estadosJuego == EstadosJuego.GANO ){
            ...
            timerAnimar = 0;
            timerAnimar2 = 0;
            pinguino.setPosicion2(-1000,100);
            velocidadNubes = 0;
    ...
    @Override
        public boolean touchDown(int screenX, int screenY, int pointer, int button) {
            ...
            if(estadosJuego == EstadosJuego.GANO && btnSiguiente.contiene(x,y)){
                juego.setScreen(new mx.itesm.icecreamquest.PantallaInstrucciones3(juego));
                //musica.setVolume(0);
                //musica.stop();
            }
                //musica.setVolume(0);
