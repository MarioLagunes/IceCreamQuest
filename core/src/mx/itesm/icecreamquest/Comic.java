...
public class Comic implements Screen, InputProcessor {
    ...
    private mx.itesm.icecreamquest.Fondo fondoComic;
    private mx.itesm.icecreamquest.Boton btnSiguiente,btnSkip;
    ...
    private mx.itesm.icecreamquest.Musica musicaComic;
    ...
    public void show() {
        ...
        btnSkip = new mx.itesm.icecreamquest.Boton(texturaSkip);
        fondoComic = new mx.itesm.icecreamquest.Fondo(texturaComic);
        fondoComic.setPosicion(0,-800);
        btnSiguiente = new mx.itesm.icecreamquest.Boton(texturaSiguiente);
        btnSiguiente.setPosicion(1100,0);
        batch = new SpriteBatch();
        musica = manager.get("Comic.mp3");
        musicaComic = new mx.itesm.icecreamquest.Musica(musica,true,ajuste);
    }
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if(btnSiguiente.contiene(x,y)){
            juego.setScreen(new mx.itesm.icecreamquest.PantallaInstrucciones(juego));
            musica.stop();
        }
