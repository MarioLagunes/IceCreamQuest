...
public class Nivel3 implements Screen,InputProcessor {
    private mx.itesm.icecreamquest.Juego juego;
    private Music musica;
    private mx.itesm.icecreamquest.Musica musicaNivel3;
    ...
    private mx.itesm.icecreamquest.Boton btnSalto,btnDisparar,btnDer,btnIzq,btnPausa,btnResumen,btnSalir,btnRegresar,btnSiguiente,btnGanaste,btnPerdiste;
    ...
    private int vidas = 5;
    private mx.itesm.icecreamquest.Enemigos kicha,kicha1,kicha2,kicha3,kicha4,kicha5,kicha6,kicha7,kicha8,kicha9,kicha10;
    public Preferences score3 = Gdx.app.getPreferences("ScoreNivel3");
    public Nivel3(mx.itesm.icecreamquest.Juego juego){
        this.juego = juego;
    }
    ...
    private  void cargarObjetos() {
        ...
        pinguino = new mx.itesm.icecreamquest.Personaje(texuturaPersonaje, texturaSal, textIzq, textPinSalIzq);
        ...
        btnSalto = new mx.itesm.icecreamquest.Boton(texturaSalto);
        btnSalto.setPosicion(740, -20);
        btnDisparar = new mx.itesm.icecreamquest.Boton(texturaDisparo);
        btnDisparar.setPosicion(740, 90);
        texturaDerecha = manager.get("BtnDer3.png");
        texturaIzquierda = manager.get("Btnizq3.png");
        btnDer = new mx.itesm.icecreamquest.Boton(texturaDerecha);
        btnDer.setPosicion(150, -20);
        btnIzq = new mx.itesm.icecreamquest.Boton(texturaIzquierda);
        btnIzq.setPosicion(20, -20);

        texturaPausa = manager.get("BtnPausa_azul.png");
        btnPausa = new mx.itesm.icecreamquest.Boton((texturaPausa));
        ...
        btnResumen = new mx.itesm.icecreamquest.Boton(texturaResumen);
        texturaSalir = manager.get("BTN_Salir.png");
        btnSalir = new mx.itesm.icecreamquest.Boton(texturaSalir);
        ...
        musicaNivel3 = new mx.itesm.icecreamquest.Musica(musica, true, ajuste);
        ...
        btnSiguiente = new mx.itesm.icecreamquest.Boton(texturaBtnSiguiente);
        btnRegresar = new mx.itesm.icecreamquest.Boton(textBtnRegresar);
        btnGanaste = new mx.itesm.icecreamquest.Boton(texturaBtnGanaste);
        btnPerdiste = new mx.itesm.icecreamquest.Boton(texturaBotonPerdiste);
        btnPerdiste.setPosicion(mx.itesm.icecreamquest.Juego.alto / 8, mx.itesm.icecreamquest.Juego.ancho / 4);
        btnGanaste.setPosicion(mx.itesm.icecreamquest.Juego.alto / 8, mx.itesm.icecreamquest.Juego.ancho / 4);

        //*** KICHAS ***\\
        texturaKicha = manager.get("SpriteKicha.png");
        kicha = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha1 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha2 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha3 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha4 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha5 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha6 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha7 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha8 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha9 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        kicha10 = new mx.itesm.icecreamquest.Enemigos(texturaKicha);
        ...
        kicha.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha1.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha2.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha3.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha4.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha5.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha6.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha7.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha8.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha9.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        kicha10.setEstadoKicha(mx.itesm.icecreamquest.Enemigos.EstadoKicha.BAJANDO);
        //*** FIN DE KICHAS ***\\
    }
    @Override
    public void show() {
        ...
        mx.itesm.icecreamquest.PantallaDatos camaraHUD1 = new mx.itesm.icecreamquest.PantallaDatos(camaraHUD);
        mx.itesm.icecreamquest.PantallaDatos vistaHUD1 = new mx.itesm.icecreamquest.PantallaDatos(vistaHUD);
    ...
    public void render(float delta) {
        ...
        if(estadosJuego == EstadosJuego.PAUSADO){
            fondoPausa.setPosicion(mx.itesm.icecreamquest.Juego.alto/8, mx.itesm.icecreamquest.Juego.ancho/4);
            pinguino.setEstadoMovimiento(mx.itesm.icecreamquest.Personaje.EstadoMovimiento.QUIETO);
            fondoPausa.draw(batch);
            btnResumen.setPosicion(mx.itesm.icecreamquest.Juego.ancho/6.5f, mx.itesm.icecreamquest.Juego.ancho/2);
            btnSalir.setPosicion(mx.itesm.icecreamquest.Juego.ancho/6.5f, mx.itesm.icecreamquest.Juego.alto/2);
    ...
    private void actualizarCamara(){
        ...
        else if (PosY >= alto_mapa - mx.itesm.icecreamquest.Juego.alto/2){
            camara.position.set(camara.position.x,alto_mapa- mx.itesm.icecreamquest.Juego.alto/2,0);
        }
        camara.update();
    }
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if (btnSalto.contiene(x, y)) {
            ...
            pinguino.setEstadoMovimiento(mx.itesm.icecreamquest.Personaje.EstadoMovimiento.IZQ);
        }
