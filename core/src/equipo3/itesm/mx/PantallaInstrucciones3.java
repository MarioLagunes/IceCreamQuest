 ...
 */
public class PantallaInstrucciones3 implements Screen,InputProcessor {
    ...
    public PantallaInstrucciones3(Juego juego) {
        this.juego = juego;
    }
    ...
    private void cargarImagenes() {
        ...
        manager.load("Instruccionesnivel3.png",Texture.class);
        manager.load("botonRegresar.png",Texture.class);
        manager.load("botonSiguiente.png",Texture.class);
        manager.finishLoading();
        texturaInstrucciones = manager.get("Instruccionesnivel3.png");
    ...
    public void dispose() {
        AssetManager manager = juego.getManager();
        manager.unload("Instruccionesnivel3.png");
