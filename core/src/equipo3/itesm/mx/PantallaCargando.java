...
public class PantallaCargando implements Screen {
    ...
    public void show() {
        ...
        TextureRegion[][] animacioTextura = texturaCompleta.split(540,800);
        ...
        spriteCargando.setPosition(400,0);
    ...
    public void borrar(){
        ...
        manager.unload("BtnArriba.png");
        manager.unload("Ganaste_1.png");
        manager.unload("BtnPausa.png");
        manager.unload("Pausa.png");
        manager.unload("SpriteZookDerecha.png");
        manager.unload("SpriteZookIzquierda.png");
        manager.unload("FondonivelLoop.png");
        manager.unload("FondonivelLoop2.png");
        manager.unload("Salida.png");
        manager.unload("CuadroScore.png");
        manager.unload("dardo.png");
        manager.unload("Saltar.png");
        manager.unload("BTN_Resumen.png");
        manager.unload("BTN_Salir.png");
        manager.unload("Perdiste_1.png");
        manager.unload("Nivel_1.mp3");
